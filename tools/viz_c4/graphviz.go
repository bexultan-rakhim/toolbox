...
func (v *GraphVizVisitor) visitSkind(kind SystemKind) {
    switch kind {
    case SKindActor:
...
func (v *GraphVizVisitor) visitStatus (status Status) {
  switch status {
  case StatusPlanned:
...
func (g *GraphVizVisitor) generateGraphviz(r Root) (string, error) {
  ...
  g.graphStr += "  rankdir=LR;\n"
  g.graphStr += "  layout=dot;\n"
