...
Before diving in, I want to specify what I look for refactoring. Point of refactoring for me is not some "ideal" code structure that encourges people to take unnecessary [Prima Donna Programmer](https://wiki.c2.com/?PrimaDonna) attitude that snobbishly looks at code and like a grammar nazi critiques your if-statements. Here is how I understand refactoring:

**Refactoring - changing code sturcture, without changing behavior to make it easier for new members to work on the software or easily trace errors.**

In other words there are three main measureable objectives:
