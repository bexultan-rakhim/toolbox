...
This is the trap of incorrect abstractions. If you had kept the original duplication, you could be in a better place to evolve the code for users and books separately in a much more cohesive way. But now, you have a complex two-sided issue that has to be solved both on server and client side.

In fact, there was a bigger trap of such form - architecture built for reducing duplicates: [Service Oriented Architecture](https://en.wikipedia.org/wiki/Service-oriented_architecture) - check the Wikipedia section on criticisms. It is a good read on why we went from this bloatware to microservices.

How
---
Question of the day: **How to avoid wrong abstractions?**

Avoiding wrong abstractions is an exercise of **restraint**. You have to learn to be pragmatic and a [Duct Tape Programmer](https://www.joelonsoftware.com/2009/09/23/the-duct-tape-programmer/). Meaning, form should follow function, not form over function.

### 1. The Rule of Three

This serves as a rule of thumb and is the gold standard for avoiding premature abstraction.
