...
So, if we have a problem that is not trivial, then what are the objectives? Ease of change, but this is still too vague and general to be actionable. Similar to many of the design problems, you can come up with an enless list of requirements.
