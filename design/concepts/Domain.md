...
This maps cleanly onto Vernon's advice about the core domain: it is where the most experienced people should be working, where the most explicit modeling effort should go, and where off-the-shelf solutions are inappropriate. LLM models, for now, are an off-the-shelf solution. They belong at the generic layer.
