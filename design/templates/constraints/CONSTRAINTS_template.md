...
[KIND <CONTRACT | IFNRA | TIMING | SCHEMA >]: [Short Descriptive Title]
  ...
  Safe changes: [What can the AI do without fear?]
  Unsafe changes: [What are the specific "red lines"?]
  Verification: [How to manually check this if automation is impossible]
